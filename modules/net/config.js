...
const env_hosts = {
  ...
  dev: {
    def: 'https://sales-dev.bnq.com.cn',
    worker: 'https://ds-dev.bnq.com.cn', //path:原bnq_worker->work的接口域名
    yingxiao: 'https://yingxiao-dev.bnq.com.cn',
    trade: 'https://trade-dev.bnq.com.cn/trade-web',
    customer: 'https://customer-dev.bnq.com.cn/customerGateway',
    customer2: 'https://customer-dev.bnq.com.cn/customer',
    cart: 'http://cart-dev.bnq.com.cn/cartwebService',
    pay: 'https://dev.zt.bnq.com.cn',
    zt: 'https://wy-dev.bthome.com',
    ptDomain: 'https://scgw-dev.bthome.com',
    invoice: 'https://invoice-dev.bnq.com.cn/invoiceService/',
    logistics: 'https://logistics-dev.bnq.com.cn/logisticsAdmin', // 物流
    H5Domain: 'https://dhstatic.bthome.com/dev/web/designer/index.html#/', //榜单等H5入口
    marketWebDomain: 'https://m.market.bnq.com.cn',
    promotion: 'https://promotion-dev.bnq.com.cn/promotion-service', //促销中心
    promotionDomain: 'https://promotion-dev.bnq.com.cn/promotion-service', //促销中心
